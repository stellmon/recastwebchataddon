 ...
 */
package com.sap.hybris.se.recastwebchataddon.jalo;
...
import com.sap.hybris.se.recastwebchataddon.constants.RecastwebchataddonConstants;



/**
 * This is the extension manager of the Recastwebchataddon extension.
 */
public class RecastwebchataddonManager extends GeneratedRecastwebchataddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecastwebchataddonManager.class.getName());
	 ...
	 */
	public static RecastwebchataddonManager getInstance()
	{
		return (RecastwebchataddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RecastwebchataddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecastwebchataddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecastwebchataddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecastwebchataddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecastwebchataddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
